"""
Faça um programa, em Python 3.x, que receba strings e, a partir de uma função, 
escreva uma nova STRING com as vogais (de forma não repetida) antes das consoantes  
